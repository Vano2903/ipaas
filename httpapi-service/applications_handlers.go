...
// swagger:route POST /app/new applications new-application
//
// # This is a summary
//
// This is a description (longer)
//
// responses:
//
//	200: SuccessResponseDynamic
//	400: ErrorResponseStatic
//	500: ErrorResponseStatic
func (h Handler) NewApplicationHandler(w http.ResponseWriter, r *http.Request) {
	...
	student, err := GetUserFromCookie(r, conn)
	if err != nil {
	...
	//read post body
	var appPost ApplicationRequest
	...
	//todo: check all the fields before sending them to the rabbitmq
