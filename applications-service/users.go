...
type Student struct {
	...
	IsAdmin     bool   `bson:"isAdmin" json:"isAdmin"`         //is the student an admin?
	IsValidator bool   `bson:"isValidator" json:"isValidator"` //is the student a validator? (this student will check if reports from other students are valid)
}
